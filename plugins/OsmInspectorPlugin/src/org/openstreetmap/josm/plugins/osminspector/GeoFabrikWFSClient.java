...
public class GeoFabrikWFSClient {
	...
	public FeatureCollection<SimpleFeatureType, SimpleFeature> getFeatures( String typeName )
...
//			GeoFabrikWFSClient theTest = new GeoFabrikWFSClient( new Bounds(-124.0, -120.0, 32.0, 36.0));
//			theTest.initializeDataStore();
//			FeatureCollection<SimpleFeatureType, SimpleFeature> features = theTest.getFeatures();
//			OsmInspectorLayer inspector = new OsmInspectorLayer( theTest.getData());
